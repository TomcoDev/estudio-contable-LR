      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2 lg:order-1 text-center lg:text-left space-y-8">
            ...
            <p className="text-professional-gray text-lg md:text-xl font-sans max-w-xl mx-auto lg:mx-0 leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-4">
              <a 
                ...
                target="_blank"
                rel="noreferrer"
                className="bg-midnight text-pure-white px-8 py-4 rounded-lg font-sans font-bold text-lg hover:bg-gold hover:-translate-y-1 transition-all duration-300 shadow-xl flex items-center justify-center gap-2"
              >
            ...
            <div className="pt-8 border-t border-gray-100 flex flex-col sm:flex-row gap-6 justify-center lg:justify-start">
              <div className="flex items-center gap-2 text-sm text-professional-gray font-sans">
