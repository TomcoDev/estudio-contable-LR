...
const Footer = () => {
  ...
  return (
    <footer className="bg-midnight text-pureWhite pt-16 pb-8 border-t border-gold/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="flex flex-col space-y-4">
            ...
            />
            <p className="text-professionalGray text-sm font-sans leading-relaxed">
            ...
            <ul className="flex flex-col space-y-3">
              {NAV_LINKS.map((link: NavLink) => (
                <li key={link.label}>
                  <a 
                    href={link.href} 
                    className="text-gray-300 hover:text-pureWhite hover:translate-x-1 transition-all duration-200 inline-block text-sm"
                  >
                    {link.label}
                  </a>
                </li>
          ...
          <div>
            ...
            <ul className="flex flex-col space-y-4 text-sm text-gray-300 font-sans">
              ...
              <li className="flex items-center gap-3">
                <span className="text-gold">📞</span>
                <a href={`tel:${CONTACT_DATA.phone}`} className="hover:text-pureWhite">
                  {CONTACT_DATA.phoneDisplay} 
                </a>
              </li>
              <li className="flex items-center gap-3">
                <span className="text-gold">✉️</span>
                <a href={`mailto:${CONTACT_DATA.email}`} className="hover:text-pureWhite">
                  {CONTACT_DATA.email} 
                </a>
              </li>
            </ul>
