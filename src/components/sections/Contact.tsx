      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
        ...
        <div className="space-y-8">
          <div>
            ...
            <p className="text-4xl md:text-5xl text-pure-white font-serif font-bold">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-4 group">
              ...
              <div>
                <p className="text-sm text-professional-gray font-sans">Llámanos o escríbenos</p>
                <p className="text-pure-white font-bold text-lg">{CONTACT_DATA.phoneDisplay}</p>
              </div>
            </div>
        ...
        {/* Formulario */}
        <div className="bg-pure-white p-8 rounded-2xl shadow-2xl">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full py-4 bg-midnight text-pure-white font-sans font-bold text-lg rounded-lg hover:bg-gold transition-all duration-300 shadow-lg flex items-center justify-center gap-2"
            >
              Enviar a WhatsApp
            </button>
          </form>
